<?php
    ...
    class Model{
         ...
         * @param  array   $params   查询条件中绑定的数据，请手动做类型转换，否则按照字符串处理
         * @param  string  $order    排序顺序
         * @param  integer $page     当前页码
         * @param  integer $pagesize 每页显示的数量
         * @return array
         */
        public function getList(array $where = [], array $params = [], $page = 0, $pagesize = 20, $order = ['ID DESC']){

            if($where){

                $this->where(implode(',', $where), $params);
            }

            if($page && $pagesize){

                $this->page(intval($page))->pagesize($pagesize);
            }
         ...
         * @return int
         */
        public function getTotal(array $where = [], array $params = []){
